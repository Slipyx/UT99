...
// LadderDOM
//=============================================================================
class LadderDOM extends Ladder;
...
defaultproperties
{
     ...
     MapPrefix="DOM-"
     Maps(0)="Tutorial.unr"
     Maps(1)="Condemned.unr"
     Maps(2)="Ghardhen.unr"
     Maps(3)="Cryptic.unr"
     Maps(4)="Cinder.unr"
     Maps(5)="Gearbolt.unr"
     Maps(6)="Leadworks.unr"
     Maps(7)="Olden.unr"
     Maps(8)="Sesmar.unr"
     Maps(9)="MetalDream.unr"
     ...
     MapAuthors(6)="Myscha the sled dog"
     MapAuthors(7)="Alan Willard 'Talisman'"
     MapAuthors(8)="Juan Pancho Eekels"
     MapAuthors(9)="Cedric 'Inoxx' Fiorentino"
     ...
     MatchInfo(1)="Botpack.RatedMatchDOM1"
     MatchInfo(2)="Botpack.RatedMatchDOM3"
     MatchInfo(3)="Botpack.RatedMatchDOM4"
     MatchInfo(4)="Botpack.RatedMatchDOM5"
     MatchInfo(5)="Botpack.RatedMatchDOM6"
     MatchInfo(6)="Botpack.RatedMatchDOM7"
     MatchInfo(7)="Botpack.RatedMatchDOM8"
     MatchInfo(8)="Botpack.RatedMatchDOM9"
     MatchInfo(9)="Botpack.RatedMatchDOM10"
}
