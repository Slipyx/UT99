class RatedMatchChal2 extends RatedMatchInfo;
...
defaultproperties
{
     ...
     BotSkins(0)="SGirlSkins.fwar"
     BotSkins(1)="SoldierSkins.hkil"
     BotSkins(2)="SGirlSkins.fwar"
     BotSkins(3)="SGirlSkins.fwar"
     BotFaces(0)="SGirlSkins.Fury"
     BotFaces(1)="SoldierSkins.Tensor"
     BotFaces(2)="SGirlSkins.Cathode"
