class RatedMatchChal1 extends RatedMatchInfo;
...
defaultproperties
{
     ...
     BotSkins(0)="SoldierSkins.hkil"
     BotSkins(1)="SGirlSkins.fwar"
     BotSkins(2)="SoldierSkins.hkil"
     BotSkins(3)="SGirlSkins.fwar"
     BotSkins(4)="SGirlSkins.fwar"
     BotFaces(0)="SoldierSkins.Vector"
     BotFaces(1)="SGirlSkins.Cathode"
     BotFaces(2)="SoldierSkins.Matrix"
     BotFaces(3)="SGirlSkins.Lilith"
     BotFaces(4)="SGirlSkins.Fury"
