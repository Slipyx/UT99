class RatedMatchDM3 extends RatedMatchInfo;
...
defaultproperties
{
     ...
     BotSkins(2)="FCommandoSkins.daco"
     BotSkins(3)="CommandoSkins.daco"
     BotFaces(0)="SoldierSkins.Slain"
     BotFaces(1)="SGirlSkins.Annaka"
     BotFaces(2)="FCommandoSkins.kyla"
